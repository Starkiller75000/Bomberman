...
irrlicht::irrlicht(irr::video::E_DRIVER_TYPE os, int x, int y)
{
        ...
        scenemgr->addCameraSceneNode(0, irr::core::vector3df((x + 1) / 2, (y + 1) / 2, ((x + y) / 2) * -1), irr::core::vector3df((x + 1) / 2, (y + 1) / 2, 180), -1, true);
...
{
        return scenemgr->createFlyCircleAnimator(irr::core::vector3df(10,10,0), 10.0f);
}
